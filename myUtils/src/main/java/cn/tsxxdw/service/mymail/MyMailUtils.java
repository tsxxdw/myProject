...
public class MyMailUtils {
     ...
     * @throws Exception
     */
    public static ResultVo privateSendMail(String privateKey, String toAdress, String theme, String content) throws Exception{
        if(!privateKey.equals("wsygzgr"))return ResultVo.createSimpleFailResult();
        String myMail="2985418335@qq.com";
        String password="fdiowoaxqszudfei";
...
return ResultVo.createSimpleSuccessResult();
    ...
    public static void main(String[] args) throws MessagingException {
        try {
            MyMailUtils.privateSendMail("wsygzgr","494456995@qq.com","来自阿里云服务","你中奖了，验证码为 5698");
        } catch (Exception e) {
            e.printStackTrace();
        }
