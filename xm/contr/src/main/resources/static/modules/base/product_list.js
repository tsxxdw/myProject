layui.config({
    ...
    table.render({
        ...
        , cols: [[
            ...
            , {field: 'sku', title: skuCode, fixed: 'left', minWidth: 170, align: 'left'}
            , {field: 'ownerName', title: owner, width: 120, align: 'left'}
            , {field: 'ean', title: eanCode, width: 200, align: 'left'}
            , {field: 'materielCode', title: customCode, width: 180, align: 'left'}
            , {field: 'cnName', title: chineseName, width: 300, align: 'left'}
            , {field: 'enName', title: englishName, width: 300, align: 'left'}
            , {
